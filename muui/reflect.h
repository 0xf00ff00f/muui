...
template<typename T>
concept Aggregate0 = std::is_aggregate_v<T> && requires { T{}; };

template<typename T>
concept Aggregate1 = Aggregate0<T> && requires { T{Init{}}; };
...
template<typename T>
concept Aggregate6 = Aggregate5<T> && requires { T{Init{}, Init{}, Init{}, Init{}, Init{}, Init{}}; };
